...
Hungarian mapping policies, EMAS_HG's non-independent role, and hashes of all primary
metric tables. Reference sensitivity is a separate output and cannot overwrite the
primary metric checksums.
